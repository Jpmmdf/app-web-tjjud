...
- `main-delivery.yml`: executa no `push` da `main`, detecta as areas alteradas, roda a CI relevante, abre ou atualiza PRs de release, autoaprova e mescla PRs de release validas e, quando uma release e criada, chama os jobs de publicacao Docker
