workspace "TJJUD Editorial Platform" "Cloud-native model for the TJJUD editorial catalog solution." {
    model {
        ...
        reviewer = person "Avaliador tecnico" "Revisa a entrega funcional e a arquitetura da solucao."

        platform = softwareSystem "Plataforma Editorial TJJUD" "Solucao API-first para catalogo editorial e relatorio por autor." {
        ...
        engineer -> platform "Evolui contrato, deploy e operacao da solucao" "Browser / Git / CI"
        reviewer -> platform "Avalia comportamento funcional e arquitetura publicada" "Browser"
        ...
        deploymentEnvironment "Cloud Native" {
            deploymentNode "Edge Zone" {
                infrastructureNode "Managed Ingress" "Termina TLS, publica a SPA e roteia /api."
