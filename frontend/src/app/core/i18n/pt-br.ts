export const ptBrCatalogMessages = {
  ...
  books: {
    ...
    filters: {
      ...
      authorSearchPlaceholder: 'Digite parte do nome do autor',
      subjectSearchPlaceholder: 'Digite parte do nome do assunto',
      ...
      searchingAuthors: 'Buscando autores no banco.',
      searchingSubjects: 'Buscando assuntos no banco.',
      ...
      selectedSubject: (description: string) => `Assunto selecionado: ${description}`,
      clearAuthorSelection: 'Limpar autor selecionado',
      clearSubjectSelection: 'Limpar assunto selecionado',
    },
