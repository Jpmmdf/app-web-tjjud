...
public class AuthorController {
    ...
    @GetMapping("/{authorId}")
    public AuthorResponse get(@PathVariable Long authorId) {
    ...
    @PutMapping("/{authorId}")
    public AuthorResponse update(@PathVariable Long authorId, @Valid @RequestBody AuthorUpsertRequest request) {
